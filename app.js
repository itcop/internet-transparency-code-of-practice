...
// Step 3 download control now downloads the BADGE artifact (SVG), not the
// receipt JSON. We fetch the on-light badge SVG and save it locally so the
// signatory walks away with the mark itself.
const BADGE_SVG_URL = "assets/0pn-badge.svg";
...
const buildEmbedSnippet = () =>
  [
    ...
    '  <img src="https://itcop.org/assets/0pn-badge.svg"',
