const i18n = {
  en: {
    ...
    whitepaper: {
      label: "White paper",
      heading: "Transparency by Default",
      byline: "By Mark Lizar and Michele Drgon. Transparency and Consent Interoperability Expert Group, version 0.1.",
      bodyOne: "The Internet Transparency Stack, co-regulated identification, and Operational Transparency for AI, set out as one connected argument: governance expressed as a record generated by the operation, not a document written about it afterwards.",
      bodyTwo: "The paper is issued through an AI Receipt gate. Opening the full text presents you a first notice and returns an anonymous knowledge reuse receipt, the same mechanism the paper argues for. The abstract stays open and carries the reuse reservation.",
  ...
  fr: {
    ...
    whitepaper: {
      label: "Livre blanc",
      heading: "Transparence par défaut",
      byline: "Par Mark Lizar et Michele Drgon. Transparency and Consent Interoperability Expert Group, version 0.1.",
      bodyOne: "La pile de transparence d'Internet, l'identification co-régulée et la transparence opérationnelle pour l'IA, présentées comme un seul argument continu : une gouvernance exprimée comme un enregistrement produit par l'opération, et non un document rédigé après coup.",
      bodyTwo: "Le livre blanc est délivré au moyen d'un accès à reçu d'IA (AI Receipt gate). L'ouverture du texte intégral vous présente d'abord un avis et renvoie un reçu anonyme de réutilisation de connaissances, le mécanisme même que défend le document. Le résumé reste ouvert et porte la réserve de réutilisation.",
